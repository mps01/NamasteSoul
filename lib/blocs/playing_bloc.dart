...
class UpdateSoundVolume extends PlayingSoundsEvent {
  ...
  const UpdateSoundVolume({@required this.soundId, @required this.volume})
...
class StopSound extends PlayingSoundsEvent {
  ...
  const StopSound({@required this.soundId}) : assert(soundId != null);
